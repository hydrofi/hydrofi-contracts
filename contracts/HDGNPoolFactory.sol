...
// File: contracts/HDGNPoolInitializable.sol

pragma solidity 0.6.12;

contract HDGNPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public HDGN_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == HDGN_POOL_FACTORY, "Not factory");
...
// File: contracts/HDGNPoolFactory.sol

pragma solidity 0.6.12;

contract HDGNPoolFactory is Ownable {
    event NewHDGNPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(HDGNPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        HDGNPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewHDGNPoolContract(smartChefAddress);
    }
}
